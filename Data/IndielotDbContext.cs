...
public class IndielotDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Models.Task>().HasData(new Models.Task[]
        {
            new()
            {
                Id = Guid.Parse("fe55ea20-4cae-463a-9aa3-eb5b5106ddff"), ProductionId = Guid.Parse("507aa23a-bbb3-4fe1-bc76-1fb3437b5be3"), Title = "SFX", Description = "Finish post sound sfx placement", TaskStatus = Models.TaskStatus.InProgress, AssignedCrewId = Guid.Parse("294031fb-226b-491b-bf61-8ea2f6171b1e")
            },
            new()
            {
                Id = Guid.Parse("f8246c24-7bbb-4a35-af08-64187bd9a7a4"), ProductionId = Guid.Parse("b9e4cf53-6075-4270-a2d5-8451c3f708d4"), Title = "Raise Funding", Description = "Acquire funding through Kickstarter", TaskStatus = Models.TaskStatus.InProgress, AssignedCrewId = Guid.Parse("a67fca84-da24-4faf-bfc3-84b97d3951d2")
            },
            new()
            {
                Id = Guid.Parse("ee640c55-80fd-442f-aceb-8e27923d9f6a"), ProductionId = Guid.Parse("020f13be-c902-4a27-a6c6-b3dea5fa880c"), Title = "Finish Script v1", Description = "Finish the first draft of script", TaskStatus = Models.TaskStatus.InProgress, AssignedCrewId = Guid.Parse("294031fb-226b-491b-bf61-8ea2f6171b1e")
            }
        });
